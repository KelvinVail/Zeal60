...
layer_1_indicator_color=10,86,92 ^
layer_1_indicator_row_col=all ^
layer_2_indicator_color=83,63,76 ^
layer_2_indicator_row_col=all ^
layer_3_indicator_color=197,86,72 ^
layer_3_indicator_row_col=all
...
FN_MO23  KC_A     KC_S     KC_D     KC_F     KC_G     KC_H     KC_J     KC_K     KC_L     KC_SCLN  KC_QUOT  KC_ENT   KC_NO   ^
...
zeal60 keymap 2 ^
LGUI(KC_L)  KC_F1    KC_F2    KC_F3    KC_F4    KC_F5    KC_F6    KC_F7    KC_F8    KC_F9    KC_F10   KC_F11   KC_F12  KC_DEL  ^
KC_TRNS  KC_TRNS  KC_TRNS  KC_EXSEL KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_BSLS ^
